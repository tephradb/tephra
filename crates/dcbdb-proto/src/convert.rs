//! Conversions between the wire protobuf types and the shared `dcbdb-core` vocabulary.
//!
...
//! validation goes through the `dcbdb-core` constructors, so there is a single definition
...
use dcbdb_core::{AppendCondition, EventType, NameError, Position, Query, QueryItem, Tag, Tags};

use crate::dcbdb as pb;

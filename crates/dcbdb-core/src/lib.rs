//! Shared vocabulary for dcbdb: the concepts a client and the storage engine both speak.
//!
...
//!
//! The engine re-exports these types, so `dcbdb::Query` and [`dcbdb_core::Query`](Query)

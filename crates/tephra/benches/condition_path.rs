...
//! TEPHRA_BENCH_DIR=/mnt/nvme cargo bench --bench condition_path   # on real storage
//! ```
//!
...
//! I/O on a cold cache). Point `TEPHRA_BENCH_DIR` at the device under test. This mirrors the
